...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val el1 = findViewById<HagoExpandableLayout>(R.id.expandable_layout_1)
        val btnToggle = findViewById<Button>(R.id.btn_toggle_1)
        btnToggle.setOnClickListener {
            el1.toggle()
        }

        val el2 = findViewById<HagoExpandableLayout>(R.id.expandable_layout_2)
        ...
        val el3 = findViewById<HagoExpandableLayout>(R.id.expandable_layout_3)
        ...
        val el4 = findViewById<HagoExpandableLayout>(R.id.expandable_layout_4)
